#!/usr/bin/env python3
"""
Recupero codici sconto Michael Kors da shopilo.it
Sursa: https://shopilo.it/negozi/michaelkors.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/michaelkors.it"
STORE_NAME = "Michael Kors"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Michael Kors da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-michaelkors)"
    }
    try:
